...
<body <?php body_class(); ?>>
<nav id="nav-fix-top" class="navbar d-none d-lg-flex">
  <div class="container">
  ...
  <div class="container">
    <a class="navbar-brand" href="<?php echo esc_url_raw(home_url()); ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/logo-motors-listing-3.svg" alt="logo sito"></a>
      ...
      <div class="collapse navbar-collapse " id="bs4navbar">
        <div class="container-nav-main-mobile">
          <?php
          wp_nav_menu([
            'menu'            => 'header',
      ...
      <div class="container-nav-help-mobile">
        <?php
        wp_nav_menu([
          'menu'            => 'social-help',
          'theme_location'  => 'social-help',
    ...
    <div class="container-utility-mobile">
      ...
      <button class="hamburger hamburger--spring navbar-toggler-right" type="button" data-toggle="collapse" data-target="#bs4navbar" aria-controls="bs4navbar" aria-expanded="false" aria-label="Toggle navigation">
